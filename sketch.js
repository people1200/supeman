...
function setup() {
  ...
  monster = new Monster(1600,550,300);
 ...
 box9= new Box(600, 100, 70, 70);
  ...
  box20= new Box(1500, 100, 70, 70);
  box21= new Box(1500, 100, 70, 70);
  box22= new Box(1500, 100, 70, 70);
}
...
function mouseDragged(){
  Matter.Body.setPosition(here.body,{ x: mouseX, y:mouseY})
}
